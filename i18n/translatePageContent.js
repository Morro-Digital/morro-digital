 ...
 */
export function translatePageContent(lang = "pt") {
 ...
 */
/**
 * Obtém uma tradução de texto com base na chave e no idioma atual
 * @param {string} key - Chave de tradução
 * @param {string} [lang] - Idioma (opcional)
 * @returns {string}
 */

export function getGeneralText(key, lang = currentLang) {
...
const translations = {
  pt: {
    ...
    welcome_message: "Bem-vindo ao Morro Digital!",
    ask_first_time: "É a sua primeira vez usando o app?",
    pois_nearby: "{count} pontos de interesse nas proximidades",
    ...
    unknown: "Movimento desconhecido",
    head: "Siga na direção",
    depart: "Comece indo para",
    arrive: "Chegou ao destino",
    continue: "Continue em frente",
    roundabout: "Entre na rotatória e pegue a saída",
    roundaboutTurn: "Vire na rotatória",
    roundaboutExit: "Saia da rotatória na saída",
    turn: "Vire",
    merge: "Entre na via",
    onRamp: "Pegue a rampa de acesso",
    offRamp: "Pegue a saída",
    fork: "Na bifurcação",
    endOfRoad: "No fim da rua, vire",
    newName: "Continue, a via muda de nome para",
    turnSharpLeft: "Vire acentuadamente à esquerda",
    turnSlightLeft: "Vire levemente à esquerda",
    turnLeft: "Vire à esquerda",
    turnSharpRight: "Vire acentuadamente à direita",
    turnSlightRight: "Vire levemente à direita",
    turnRight: "Vire à direita",
    ...
    ferry: "Pegue a balsa",
    construction: "Via em construção, siga com cuidado",
    useLane: "Use a faixa indicada",
    continueStraight: "Continue reto",
    takeExit: "Pegue a saída",
    takeRoundabout: "Entre na rotatória",
    exitRoundabout: "Saia da rotatória",
    changeLaneLeft: "Mude para a faixa da esquerda",
    changeLaneRight: "Mude para a faixa da direita",
    enterTunnel: "Entre no túnel",
    exitTunnel: "Saia do túnel",
    tollBooth: "Cabine de pedágio à frente",
    borderControl: "Controle de fronteira à frente",
    trafficCalming: "Redutor de velocidade à frente",
    railwayCrossing: "Passagem de nível à frente",
    tunnel: "Túnel à frente",
    stop: "Pare",
